...
<head>
   ...
   <!-- Times New Roman Font for all elements -->
   <style>
      body, h1, h2, h3, h4, h5, h6, p, span, div, a, input, select, textarea, button {
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="category"><strong>Category:</strong> <?= ucfirst($fetch_products['category']); ?></div>
      <div class="flex-btn">
